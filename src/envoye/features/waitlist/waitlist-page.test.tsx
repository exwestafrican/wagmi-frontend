...
import WaitListPage from "@envoye/features/waitlist/waitlist-page"
...
import type { WaitlistStore } from "@envoye/features/waitlist/store/useWaitlistStatus"
import type { RoadmapFeature } from "@envoye/features/waitlist/interfaces/roadmap-feature"
import {
	USER_VOTES,
	type UserVotesResponse,
} from "@envoye/features/waitlist/api/user-votes"
import {
	inProgressFeatureFactory,
	plannedFeatureFactory,
} from "@envoye/test/factory/feature"
...
vi.mock("@envoye/features/waitlist/store/useWaitlistStatus", () => ({
	useWaitlistStore: (
